...
#define ESP_UI_PHONE_1024_600_DARK_BACKSTAGE_SNAPSHOT_DATA_DEFAULT()   \
    {                                                                  \
        .main_size = ESP_UI_CORE_OBJECT_SIZE_RECT(576, 360),           \
        .title = {                                                     \
            .main_size = ESP_UI_CORE_OBJECT_SIZE_RECT(576, 22),        \
            .main_layout_column_pad = 10,                              \
            .icon_size = ESP_UI_CORE_OBJECT_SIZE_SQUARE(22),           \
            .text_font = ESP_UI_CORE_FONT_DEFAULT_SIZE(22),            \
            .text_color = ESP_UI_CORE_COLOR(0xFFFFFF),                 \
        },                                                             \
        .image = {                                                     \
            .main_size = ESP_UI_CORE_OBJECT_SIZE_RECT(576, 338),       \
        },                                                             \
    }
...
#define ESP_UI_PHONE_1024_600_DARK_BACKSTAGE_DATA_DEFAULT()                      \
    {                                                                            \
        ...
        .memory = {                                                              \
            ...
            .label_text_font = ESP_UI_CORE_FONT_DEFAULT_SIZE(22),                \
