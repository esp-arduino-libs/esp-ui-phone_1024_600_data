...
LV_IMG_DECLARE(esp_ui_phone_1024_600_recents_screen_trash_image);

#define ESP_UI_PHONE_1024_600_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()   \
    {                                                                  \
...
#define ESP_UI_PHONE_1024_600_DARK_RECENTS_SCREEN_DATA()                      \
    {                                                                            \
        .main = {                                                                \
        ...
        .snapshot_table = {                                                      \
            ...
            .snapshot = ESP_UI_PHONE_1024_600_DARK_RECENTS_SCREEN_SNAPSHOT_DATA(), \
        },                                                                       \
        .trash_icon = {                                                          \
            .default_size = ESP_UI_STYLE_SIZE_SQUARE(48),                  \
            .press_size = ESP_UI_STYLE_SIZE_SQUARE(43),                    \
            .image = ESP_UI_STYLE_IMAGE(&esp_ui_phone_1024_600_recents_screen_trash_image), \
        },                                                                       \
        .flags = {                                                               \
            .enable_memory = 1,                                                  \
